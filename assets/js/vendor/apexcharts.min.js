		...
		return s(i, [{
			...
			value: function() {
				...
				if (e && "object" === t(e)) {
					...
					"line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "on" !== e.xaxis.tickPlacement || s.convertCatToNumeric(),
						...
						if (e.globals.dataChanged) {
							...
							if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
								...
								S || (S = "rgba(255, 255, 255, 0)"),
									this.animateHeatColor(w, d.isColorHex(S) ? S : d.rgb2hex(S), d.isColorHex(m) ? m : d.rgb2hex(m), A)
							}
						}
			...
			value: function(t, e) {
				...
				i.config.yaxis.length > 1 && (this.multipleYs = !0),
					i.config.yaxis.map(function(o, l) {
						...
						o.opposite ? (a = i.globals.gridWidth + i.globals.translateX + r,
						h || (r = r + c + 20),
